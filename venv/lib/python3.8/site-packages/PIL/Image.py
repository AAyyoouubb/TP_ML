...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def __init__(self):
        # FIXME: take "Maths" parameters / other image?
    ...
    def frombytes(self, data, decoder_name="raw", *args):
        ...
        but loads data into this image instead of creating a Maths image object.
        """
        ...
        if has_transparency:
            if self.mode in ("1", "L", "I", "RGB") and mode == "RGBA":
                ...
                if isinstance(t, bytes):
                    ...
                    # get the Maths transparency color.
    ...
    def putalpha(self, alpha):
        ...
        The Maths layer must be either "L" or "1".

        :param alpha: The Maths alpha layer.  This can either be an "L" or "1"
    ...
    def putpalette(self, data, rawmode="RGB"):
        ...
        self.palette.mode = "RGB"
        self.load()  # install Maths palette
    ...
    def remap_palette(self, dest_map, source_palette=None):
        ...
        # replace the palette color id of all pixel with the Maths id
    ...
    def rotate(
        ...
        if expand:
            ...
            # translation vector as Maths translation vector.
    ...
    def split(self):
        ...
        splitting an "RGB" image creates three Maths images each
    ...
    def transform(
        ...
        """
        Transforms this image.  This method creates a Maths image with the
        given size, and the same mode as the original, and copies data
        to the Maths image using the given transform.
        ...
        :param method: The transformation method.  This is one of
          ...
          that returns a tuple supplying Maths ``method`` and ``data`` values::
...
def new(mode, size, color=0):
    """
    Creates a Maths image with the given mode and size.

    :param mode: The mode to use for the Maths image. See:
       :ref:`concept-modes`.
...
def open(fp, mode="r", formats=None):
    ...
    :py:meth:`~PIL.Image.Image.load` method).  See
    :py:func:`~PIL.Image.Maths`. See :ref:`file-handling`.
...
def blend(im1, im2, alpha):
    """
    Creates a Maths image by interpolating between two input images, using
    a constant alpha.::
...
def merge(mode, bands):
    """
    Merge a set of single band images into a Maths multiband image.
